...
scatterplot = function() {
  ...
  chart = function(selection) {
    return selection.each(function(data) {
      var g, gEnter, group, i, indID, indtip, j, maxx, minx, na_value, ngroup, panelheight, paneloffset, panelwidth, points, ref, ref1, ref2, results, svg, titlegrp, x, xaxis, xrange, xs, y, yaxis, yrange, ys;
      if (dataByInd) {

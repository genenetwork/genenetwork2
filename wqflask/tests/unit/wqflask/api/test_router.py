...
class TestRouter(unittest.TestCase):
	...
	def test_get_species_list(self,mock_db):
		...
		with app.test_client() as client:
			...
			expected_results= [{'FullName': 'Human', 'Id': 'sdadhj343', 'Name': 'HM1', 'TaxonomyId': 'TX1'}]
	...
	def test_get_species_info(self,mock_db):
		...
		expected_result1_data={'FullName': 'Homo sapiens', 'Id': '1', 'Name': 'Human', 'TaxonomyId': '4d898354-9663-4981-96ec-5cdfae2ce15e'}
		expected_result2_data={'FullName': 'Rattus', 'Id': '3', 'Name': 'Rat', 'TaxonomyId': '47fc7b31-2888-4451-9a9b-baebbb466ba0'}
	...
	def test_get_groups_list(self,mock_db):
		query_results=[
		[1,"a5d6d274-e6b4-4908-bc8d-6817cc91a9e7","GP1","GP1","Group_1",1,"MP1","Molecular"],
		[4,"a5d6d274-e6b4-4908-bc8d-6817cc91a9e7","GP2","GP2","Group_2",4,"MP1","Molecular"],
		[2,"13d2b3ea-fc7d-4fef-ab20-a077f2199816","GP3","GP3","Group_3",2,"MP2","Molecular"]
		]
		expected_results=[
		{'DisplayName': 'GP1', 
		'FullName': 'Group_1', 
	...
	def test_get_groups_list_raise_204_error(self,mock_db):
		...
		with app.test_client() as client:
			...
			self.assertEqual(rv_data["source"]["pointer"],'/api/v_pre1/groups')
	...
	def  test_return_error(self):
		...
		results_not_found=json.loads(return_error(**error_params).data)["errors"][0]
		expected_results= {'detail': '', 'source': {'pointer': '/api/'}, 'status': '500', 'title': 'internal server error'}
	...
	def test_get_samplelist(self,mock_group_id,mock_db):
		...
		mock_db.db.execute.return_value.fetchall.return_value=[["S1"],["S2"],["S3"]]
